...
namespace NEventStore.Persistence.MongoDB
{
	...
	public static class ExtensionMethods
	{
		...
		/// this function was disabled because inconsistent with the deserialization strategy
		/// we do not have option to customize the serialization yet, will be introduced again when
		/// we implement issue: #38
		public static BsonDocument ToMongoCommit_Disabled(this CommitAttempt commit, Int64 checkpoint, IDocumentSerializer serializer)
		{
		...
		/// we do not have option to customize the serialization yet, will be introduced again when
		/// we implement issue: #38
		public static BsonDocument ToEmptyCommit_Disabled(this CommitAttempt commit, Int64 checkpoint, IDocumentSerializer serializer, String systemBucketName)
		{
		...
		public static BsonDocument ToEmptyCommit(this CommitAttempt commit, Int64 checkpoint, IDocumentSerializer serializer, String systemBucketName)
		{
			...
			return new BsonDocument
			{
				...
				{MongoCommitFields.CommitId, commit.CommitId},
				{MongoCommitFields.CommitStamp, commit.CommitStamp},
				{MongoCommitFields.Headers, new BsonDocumentWrapper(new Dictionary<String, Object>(), DictionarySerializerSelector.DictionarySerializer) }, // new BsonDocumentWrapper(commit.Headers, dictionarySerialize)},
                {MongoCommitFields.Events, new BsonArray(new Object[] { })},
				{MongoCommitFields.StreamRevisionFrom, 0},
				{MongoCommitFields.StreamRevisionTo, 0},
				{MongoCommitFields.BucketId, systemBucketName},
				{MongoCommitFields.StreamId, systemBucketName + ".empty." + checkpoint},
				{MongoCommitFields.CommitSequence, 1}
			};
		}
